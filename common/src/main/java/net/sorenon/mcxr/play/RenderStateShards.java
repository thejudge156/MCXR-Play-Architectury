...
public class RenderStateShards {
    ...
    //Custom
    public static final RenderStateShard.LineStateShard AUTO_LINE = new RenderStateShard.LineStateShard(OptionalDouble.empty());

    public static RenderStateShard.DepthTestStateShard depthTest(String name, int depthFunction) {
        return new RenderStateShard.DepthTestStateShard(name, depthFunction);
    }
    ...
    public static RenderStateShard.LineStateShard lineWidth(double lineWidth) {
        return new RenderStateShard.LineStateShard(OptionalDouble.of(lineWidth));
    }
}
